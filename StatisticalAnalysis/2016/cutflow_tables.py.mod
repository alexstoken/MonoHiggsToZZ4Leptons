...
if __name__ == "__main__":
  ...
  flist4mu = map(lambda x: x.split()[-1], open('filelist_4mu_2016_Spring16_AN_Bari_Giorgia.txt').readlines()) 
  ...
  '''
  # 4, 5, 7?, 8, 10, 11
  # HLT, At least 2 tight lept., Z candidate, m_{Z}, Z_{2} pairs > 1, m4l > 70
  # Fill in template latex table with yields
  cardin = open('cutflow_tmp.txt')
  cardout = open('cutflow_table_4mu.txt','w')
  for l in cardin:
    if 'HLT' in l:
      l = 'HLT & ' + str('%.3g'%qqZZ4mu[4]) + ' & ' + str('%.3g'%ggZZ4mu[4]) + ' & ' + str('%.3g'%ZX4mu[4]) + ' & ' + str('%.3g'%ZH4mu[4]) + ' & ' + str('%.3g'%Hsig4mu[4]) + ' & ' + str('%.3g'%bkg4mu[4]) + ' & ' + str('%.3g'%sig6004mu[4]) + ' & ' + str('%.3g'%Obs4mu[4]) + ' \\\\ \n' 
    if 'tight' in l:
      l = 'At least 2 tight lept. & ' + str('%.3g'%qqZZ4mu[5]) + ' & ' + str('%.3g'%ggZZ4mu[5]) + ' & ' + str('%.3g'%ZX4mu[5]) + ' & ' + str('%.3g'%ZH4mu[5]) + ' & ' + str('%.3g'%Hsig4mu[5]) + ' & ' + str('%.3g'%bkg4mu[5]) + ' & ' + str('%.3g'%sig6004mu[5]) + ' & ' + str('%.3g'%Obs4mu[5]) + ' \\\\ \n' 
    if '$Z$ cand.' in l:
      l = '$Z$ cand. & ' + str('%.3g'%qqZZ4mu[7]) + ' & ' + str('%.3g'%ggZZ4mu[7]) + ' & ' + str('%.3g'%ZX4mu[7]) + ' & ' + str('%.3g'%ZH4mu[7]) + ' & ' + str('%.3g'%Hsig4mu[7]) + ' & ' + str('%.3g'%bkg4mu[7]) + ' & ' + str('%.3g'%sig6004mu[7]) + ' & ' + str('%.3g'%Obs4mu[7]) + ' \\\\ \n' 
    if '$m_{Z_1}$' in l:
    ...
    if 'At least one $Z_2$' in l:
      l = 'At least one $Z_2$ & ' + str('%.3g'%qqZZ4mu[9]) + ' & ' + str('%.3g'%ggZZ4mu[9]) + ' & ' + str('%.3g'%ZX4mu[9]) + ' & ' + str('%.3g'%ZH4mu[9]) + ' & ' + str('%.3g'%Hsig4mu[9]) + ' & ' + str('%.3g'%bkg4mu[9]) + ' & ' + str('%.3g'%sig6004mu[9]) + ' & ' + str('%.3g'%Obs4mu[9]) + ' \\\\ \n' 
    if '$m_{llll} > 70$ GeV' in l:
      l = '$m_{llll} > 70$ GeV & ' + str('%.3g'%qqZZ4mu[11]) + ' & ' + str('%.3g'%ggZZ4mu[11]) + ' & ' + str('%.3g'%ZX4mu[11]) + ' & ' + str('%.3g'%ZH4mu[11]) + ' & ' + str('%.3g'%Hsig4mu[11]) + ' & ' + str('%.3g'%bkg4mu[11]) + ' & ' + str('%.3g'%sig6004mu[11]) + ' & ' + str('%.3g'%Obs4mu[11]) + ' \\\\ \n' 
    cardout.write(l)
  cardin.close()
  cardout.close()
  '''
...
4, 5, 6, 8, 10, 12, 14, 15, 16, 18
  nEvent_4l_w->GetXaxis()->SetBinLabel(1,"Init.");
   ...
   nEvent_4l->GetXaxis()->SetBinLabel(16,"Category 6");
