...
print 'WH  ZH  ggH  qqH  ttH  ggZZ  qqZZ  ZX'
print str(WH) + ' ' + str(ZH) + ' ' + str(ggH) + ' ' + str(qqH) + ' ' + str(ttH) + ' ' + str(ggZZ) + ' ' + str(qqZZ) + ' ' + str(ZX)
print str(e2WH) + ' ' + str(e2ZH) + ' ' + str(e2ggH) + ' ' + str(e2qqH) + ' ' + str(e2ttH) + ' ' + str(e2ggZZ) + ' ' + str(e2qqZZ) + ' ' + str(e2ZX)
print 'H BKG: ' + str(WH + ZH + ggH + qqH + ttH)
print 'Other BKG: ' + str(ggZZ + qqZZ + ZX)
print 'Total BKG: ' + str(WH + ZH + ggH + qqH + ttH + ggZZ + qqZZ + ZX)
print 'Data: ' + str(data)
...
for i in range(0, len(sig_labels)):
  ...
  for line in cardin:
    ...
    if 'sig' in line:
      line = 'process ' + sig_labels[i] + ' WH ZH ggH qqH ttH ggZZ qqZZ ZX ' + '\n'
    if 'YIELDS' in line:
      ...
      #else:
        line = 'rate ' + sig_yields[i] + ' ' + str(WH) + ' ' + str(ZH) + ' ' + str(ggH) + ' ' + str(qqH) + ' ' + str(ttH) + ' ' + str(ggZZ) + ' ' + str(qqZZ) + ' ' + str(ZX) + '\n'
    cardout.write(line)
  cardin.close()
  cardout.close()
