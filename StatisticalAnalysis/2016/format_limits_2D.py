...
in300 = open('limits_Zp2HDM_4l_MA0300.txt')
in400 = open('limits_Zp2HDM_4l_MA0400.txt')
in500 = open('limits_Zp2HDM_4l_MA0500.txt')
in600 = open('limits_Zp2HDM_4l_MA0600.txt')
in700 = open('limits_Zp2HDM_4l_MA0700.txt')
in800 = open('limits_Zp2HDM_4l_MA0800.txt')

limout = open('limits_Zp2HDM_2D_out.txt','w')
