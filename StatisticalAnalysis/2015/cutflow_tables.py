...
if __name__ == "__main__":
  ...
  # Read in input files
  flist4e = map(lambda x: x.split()[-1], open('filelist_4e_2015_Fall15_AN_FNAL.txt').readlines())
  flist4mu = map(lambda x: x.split()[-1], open('filelist_4mu_2015_Fall15_AN_FNAL.txt').readlines()) 
  flist2e2mu = map(lambda x: x.split()[-1], open('filelist_2e2mu_2015_Fall15_AN_FNAL.txt').readlines())
